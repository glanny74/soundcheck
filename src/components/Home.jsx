  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="relative z-10 px-6 sm:px-10 pt-8 flex items-start justify-between gap-6"
      >
        <motion.p
      ...
      <div className="relative z-10 px-6 sm:px-10 mt-12 sm:mt-20 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8">
          ...
          <motion.h1
            ...
            className="font-display font-extrabold text-text-primary
                       ...
                       text-[88px] sm:text-[140px] lg:text-[180px] xl:text-[200px]"
          >
            ...
            <span
              className="block serif-italic text-text-secondary
                         text-[34px] sm:text-[56px] lg:text-[72px]
                         leading-none mt-2 sm:mt-4 ml-[8%]"
            >
              le blind test.
            </span>
          ...
          >
            <button
              ...
              className="editorial-link group cursor-pointer
                         font-display font-medium text-2xl sm:text-3xl
                         text-text-primary"
            >
              <span>Démarrer une partie</span>
              <span className="arrow text-accent-green text-3xl sm:text-4xl leading-none">
                →
              </span>
            </button>
          </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-white/5 bg-bg-primary/60 backdrop-blur-sm py-4 overflow-hidden">
        <div className="flex w-max animate-marquee">
          {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map(
            (item, i) => (
              <span
                key={i}
                className="px-6 text-sm uppercase tracking-[0.25em] text-text-tertiary whitespace-nowrap"
              >
                {item}{' '}
